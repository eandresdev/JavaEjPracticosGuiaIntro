...
public class Ejercicio12 {
    ...
    public static void main(String[] args) {
        ...
        do { 
            System.out.println("***Ingresa un secuencia : ***");
            secuencia = scan.next();
            ...
            if (secuencia.length()==5) {
                if (letra1.equalsIgnoreCase("X") && letra2.equalsIgnoreCase("O")) {
                    ...
                    System.out.println("Secuencia incorrecta, por favor ingrese intentelo nuevamente");
                    incorrectas++;
        ...
        /// FALTA SOLUCIONAR EL ERROR DEL INGRESO DE CARACTERES MENOR A 5, SE ROMPE EL PROGRAMA EN ESA PRUEBA tanto para la salida como para los xo.
