...
public class Ejercicio13 {
    ...
    public static void main(String[] args) {
        ...
        do {  
            ...
            for (int i = 0; i <= num-1 ; i++) { // si inicializa variable en 0 hasta num-1
                
                for (int j = 0; j <= num-1; j++) { // si inicializa variable en 0 hasta num-1
                    if ((j == 0 || j == num-1) || (i == 0 || i == num-1)) { // si j o i son = 0 o num-1 entonces muestrame asterisco, si no espacio en  blanco
                         System.out.print("* ");
                    }else {
                        System.out.print("  ");
                    }
            ...
            respuesta=scan.next();
        } while (respuesta.equalsIgnoreCase("s")); // dowhile finalizado una vez  lee "s" como respuesta 
